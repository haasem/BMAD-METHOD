...
- Use the vocabulary of the user's domain and tech stack. Don't import terms from adjacent domains when native terms exist (e.g., "Preflight" from web/DevOps in a Salesforce context where "Pre-Check" or "Validation" is native). When the project documents a preferred vocabulary (CLAUDE.md, project-context.md, glossary), follow it. This matters even in technical-to-technical contexts — the user's team must recognize the terms you use in code comments, commit messages, and PR descriptions.
